...
# Mon Mar 10 02:27:26 PM CST 2025 - Unknown packages
...
AddPackage corkscrew # A tool for tunneling SSH through HTTP proxies
...
AddPackage elixir # A dynamic, functional language for building scalable and maintainable applications
...
AddPackage fcitx5-chinese-addons # Addons related to Chinese, including IME previous bundled inside fcitx4
...
AddPackage lib32-fontconfig # Library for configuring and customizing font access
...
# Mon Mar 10 02:27:28 PM CST 2025 - Unknown foreign packages
...
AddPackage --foreign wechat-bin # 微信是一种生活方式. This is a repackage of WeChat.


# Mon Mar 10 02:27:28 PM CST 2025 - Missing foreign packages


RemovePackage --foreign libva-vdpau-driver-vp9-git


# Mon Mar 10 02:27:28 PM CST 2025 - New / changed files
